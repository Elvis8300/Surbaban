package com.example.surbaban.ui.theme.screens.products
...
fun Add_ProductsScreen(){
    SurbabanTheme {
        Add_ProductsScreen(navController = rememberNavController())
    }
}